...
maxHelper x a = if x > a then x else a
...
largestHelper x [] = [x]
largestHelper x ls = if x > maximum ls then [x]
                     else if x == maximum ls then x:ls
                     else ls
