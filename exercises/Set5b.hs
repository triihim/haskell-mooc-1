...
walk (StepL:steps) (Node v l r) = walk steps l
walk (StepR:steps) (Node v l r) = walk steps r
...
search val t = if fst $ search' val t [] then Just (snd $ search' val t []) else Nothing

search' _ Empty _ = (False, [])
search' val (Node v l r) steps = if val == v
                                 then (True, reverse steps)
                                 else if not $ fst $ search' val l (StepL:steps)
                                      then search' val r (StepR:steps)
                                      else search' val l (StepL:steps)
